...
/*          g++ a2partc.cpp timer.cpp -std=c++0x         */
/*                                                       */
/*********************************************************/
...
int main(int argc, char* argv[]){
    ...
    try{
        ...
        cout << "Test 2: Add some more records (more than expected)" << endl;
        t2.reset();
        ...
        testnumber++;
        cout << "Test 8: Check that removed records are gone and other are unaffected in hashtable table..." << endl;
        t2.reset();
        for(int i=0;i<total;i++){
            t2.start();
