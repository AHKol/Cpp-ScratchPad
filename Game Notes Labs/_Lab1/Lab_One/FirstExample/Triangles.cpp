...
void drawScene(void)
{
	...
	glm::mat4 translate_view = glm::translate(glm::mat4(1.0), glm::vec3(0.5f, 0.0f, 0.0f));
	glm::mat4 model_view = glm::rotate(translate_view, rotate_value, glm::vec3(0.0f, 0.0f, 1.0f));
	

	/*
	//Creating rotation matrix using glm livrary. In this case, rotating rotat_value degree about Z axis (0, 0, 1)
	glm::mat4 rotate_view = glm::rotate(glm::mat4(1.0), rotate_value, glm::vec3(0.0f, 0.0f, 1.5f));

	//Translate the shape to simulate other
	glm::mat4 model_view = glm::translate(rotate_view, glm::vec3(0.0f, 0.5f, 0.0f));
	*/
	...
	/*
	//rotate
	rotate_view = glm::rotate(glm::mat4(1.0), (rotate_value * -1), glm::vec3(0.0f, 0.0f, 1.0f));

	//Translate the shape to simulate other
	model_view = glm::translate(rotate_view, glm::vec3(-0.5f, 0.0f, 0.0f));
	*/

	translate_view = glm::translate(glm::mat4(1.0), glm::vec3(-0.5f, 0.0f, 0.0f));
	model_view = glm::rotate(translate_view, (rotate_value * - 1), glm::vec3(0.0f, 0.0f, 1.0f));
